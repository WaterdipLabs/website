...
export const features: Array<Feature> = [
    { id: 0, img: perform, h1: "ML Performance Tracing", p: "Observer ML model's performance is one of the key activity needs to be done in production AI system. With waterdip platform one can have the continuous observability of model's performance matrices like Confusion Matrix, Moving Accuracy, AUC/ROC, Gini, Precision/Recall etc." },
